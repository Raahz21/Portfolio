          ...
          <div className="about-photo-stack">
            <div className="photo-main reveal-scale">
              <div className="photo-frame">
                <img src={import.meta.env.BASE_URL + "MainID.jpg"} alt="Vince Aerhol Cabardo" onError={(e) => { e.target.style.display = 'none'; }} />
              </div>
            ...
            <div className="flip-card flip-card-1 reveal-scale">
              <div className="flip-card-inner">
                <div className="flip-card-front">
                  <img src={import.meta.env.BASE_URL + "IDmini.jpg"} alt="Vince Aerhol" onError={(e) => { e.target.style.display = 'none'; }} />
